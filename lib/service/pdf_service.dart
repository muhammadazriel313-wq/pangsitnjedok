          ...
          return pw.Column(
            ...
            children: [
              ...
              pw.Row(
                mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                children: [
                  pw.Text("Net Profit (40%):", style: pw.TextStyle(fontWeight: pw.FontWeight.bold)),
                  pw.Text(netProfit),
                ],
              ),
              pw.SizedBox(height: 30),
              
              pw.Text("Daftar Menu Terlaris:", style: pw.TextStyle(fontSize: 18, fontWeight: pw.FontWeight.bold)),
              pw.SizedBox(height: 10),
