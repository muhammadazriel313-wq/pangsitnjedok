            ...
            children: [
              Row(
                children: [
                  ...
                  Column(
                    crossAxisAlignment:
                        CrossAxisAlignment.start, // <-- TYPO SUDAH DIPERBAIKI
      ...
      child: Column(
        children: [
          Expanded(
            child: CustomPaint(
              size: Size
                  .infinite, // <-- PARAMETER WIDTH SUDAH DIHAPUS DAN DIGANTI INI
