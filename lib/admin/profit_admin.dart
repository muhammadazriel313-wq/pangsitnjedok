            ...
            children: [
              Row(
                children: [
                  ...
                  Column(
                    // SUDAH DIPERBAIKI: TYPO TITIK DUA 
        ...
        child: Container(
          ...
          child: Row(
            ...
            children: [
              ...
              Text(DateFormat('dd MMMM yyyy').format(_selectedDate), style: const TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 16)),
...
class _ChartPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // MENGGAMBAR TITIK BULAT DI SETIAP PUNCAK HARI
