...
class _DashboardAdminState extends State<DashboardAdmin> {
  // --- VARIABEL STATE ---
  bool _isHourly = true;
  late Stream<Map<String, dynamic>> _liveDataStream;

  @override
  void initState() {
    super.initState();
    // Menjalankan stream untuk live update
            ...
            SizedBox(
              ...
              child: Row(
                ...
                children: chartData.entries.map((entry) {
                  ...
                  return Expanded(child: _buildChartBar(entry.key, barValue));
                }).toList(),
              ),
            ),
          ],
                ...
                if (snapshot.connectionState == ConnectionState.waiting &&
                  ...
                  final portraitContent = [
                    ...
                    _buildActionCard(
                      ...
                      subtitle: "Keep your selection fresh\nand updated.",
                      actionText: "MANAGE MENU →",
                      color: const Color(0xFFF7E5DB),
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(color: const Color(0x33FFCE99)),
        ),
        child: Row(
          children: [
            Container(
